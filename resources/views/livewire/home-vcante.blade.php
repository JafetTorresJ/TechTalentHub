<div>
   ...
   <div class="py-12">
      <div class="max-w-7xl mx-auto" >
        <h3 class="font-extrabold text-4xl text-gray-600 mb-12">Nuestras vacantes para ti</h3>
       ...
       @forelse ( $vacantes as $vacante )
          <div class="md:flex md:justify-between md:items-center py-5"> 
            ...
            <p class="font-bold text-xs text-gray-600">
               ultimo dia para postularse: <span class="font-normal">{{ $vacante->ultimo_dia }}</span>
            </p>
              </div>
              <div class="mt-5 md:mt-0">
               <a class="bg-indigo-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-indigo-700 block text-center " href="{{ route('vacantes.show', $vacante->id) }}">Ver vacante</a>
              </div>
          </div>
       @empty
